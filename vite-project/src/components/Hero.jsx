...
const Hero = () => {
  ...
  <button
    ...
    className="bg-white/90 backdrop-blur-md px-8 py-3 rounded-full shadow-lg border border-white/30 hover:bg-white hover:shadow-xl transition-all duration-300"
  >
    <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#49B9FF] via-[#FF7E5F] to-[#FEB47B] font-bold text-xl">
      Get a Free Quote
    </span>
  </button>
</div>
